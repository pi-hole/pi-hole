...
checkout() {
    ...
    if [[ "${1}" == "dev" ]] ; then
        ...
        echo "development" > "${PI_HOLE_CONFIG_DIR}/ftlbranch"
        chmod 644 "${PI_HOLE_CONFIG_DIR}/ftlbranch"
    elif [[ "${1}" == "master" ]] ; then
        ...
        local path
        path="master/${binary}"
        echo "master" > "${PI_HOLE_CONFIG_DIR}/ftlbranch"
        chmod 644 "${PI_HOLE_CONFIG_DIR}/ftlbranch"
    elif [[ "${1}" == "core" ]] ; then
        ...
        if check_download_exists "$path"; then
            ...
            echo "${2}" > "${PI_HOLE_CONFIG_DIR}/ftlbranch"
            chmod 644 "${PI_HOLE_CONFIG_DIR}/ftlbranch"
            FTLinstall "${binary}"
