...
<head>
    ...
    <link rel="stylesheet" href="//<?php echo $virtual_host ?>/blockingpage.css"/>
    <link rel="shortcut icon" href="//<?php echo $virtual_host ?>/admin/img/favicon.png" type="image/png"/>
    <meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0, user-scalable=no"/>
    <meta name="robots" content="noindex,nofollow"/>
</head>
<body id="body">
<header>
    <h1 style="background: url('//<?php echo $virtual_host ?>/admin/img/logo.svg') left no-repeat;"><a href="/admin">Website Blocked</a></h1>
</header>
<main>
    <div>Access to the following site has been blocked:<br/>
        <span class="pre msg"><?php echo $serverName . $uri; ?></span></div>
    <div>If you have an ongoing use for this website, please ask the owner of the Pi-hole in your network to have it
        whitelisted.
    </div>
...
<script src="//<?php echo $virtual_host ?>/admin/scripts/vendor/jquery.min.js"></script>
<script>
...
<script src="//<?php echo $virtual_host ?>/admin/scripts/pi-hole/js/queryads.js"></script>
<script>
    function inIframe() {
        try {
