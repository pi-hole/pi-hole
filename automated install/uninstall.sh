...
readonly ADMIN_INTERFACE_DIR FTL_LOG DNSMASQ_LOG WEBSERVER_LOG PIHOLE_DB GRAVITY_DB MACVENDOR_DB

readonly PI_HOLE_FILES_DIR="/etc/.pihole"
SKIP_INSTALL="true"
# shellcheck source="./automated install/basic-install.sh"
source "${PI_HOLE_FILES_DIR}/automated install/basic-install.sh"
# use package_manager_detect(), disable_service(), stop_service(),
# and restart_service() from basic-install.sh

# use Pi-hole directories from basic-install.sh
readonly PI_HOLE_CONFIG_DIR PI_HOLE_INSTALL_DIR PI_HOLE_LOCAL_REPO
        ...
        if [[ -d '/etc/systemd/system/pihole-FTL.service.d' ]]; then
            ...
            case $answer in
                [yY]*)
                    ...
                    rm -R /etc/systemd/system/pihole-FTL.service.d
